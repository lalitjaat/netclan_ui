...
class userCardMerchant extends StatelessWidget {
  const userCardMerchant({super.key});
                  ...
                  Stack(
                    ...
                    children: [
                      ...
                      Positioned(
                          ...
                          top: 65,
                          bottom: 0,
                          child: Text(merchantList[index].city)),
                      Positioned(
                        left: 75,
                        top: 90,
                        bottom: 0,
                      ...
                      Positioned(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              merchantList[index].description,
                              style: TextStyle(
